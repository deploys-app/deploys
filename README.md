...
- `upload` reads `-file` (or stdin when omitted or `-`) and prints the public, short-lived download URL; `-ttl` is 1-365 days (default 1). Requires the `dropbox.upload` permission.
